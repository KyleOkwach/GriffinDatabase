...
// MySQL query to be inserted
$sql = "SELECT * FROM good_condition";
...
echo "<tr><td>" . htmlspecialchars($row['BookName']) . "</td><td>" . htmlspecialchars($row['ISBN']) . "</td><td>" . htmlspecialchars($row['Author']) . "</td><td>" . htmlspecialchars($row['Publisher']) . "</td><td>" . htmlspecialchars($row['DOP']) . "</td></tr>";  //$row['index'] the index here is a field name
}
