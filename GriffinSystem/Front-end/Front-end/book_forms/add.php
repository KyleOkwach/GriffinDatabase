...
$sql = "INSERT INTO `book` (`bookname`, `isbn`, `author`, `publisher`, `dop`, `date added`,`cost`, `donated`, `GoodCondition?` ,`categoryname`) VALUES ('$bookName', '$ISBN', '$author', '$publisher', '$dop', '$dateAdded','$cost', '$isdonated', '$condition', '$category')";
...
if($rs)
{
	...
	echo "Error! invalid data may be invalid!";
}
